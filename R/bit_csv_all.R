#' @title Load all CSV files in a directory
#'
#' @description This function allows the user to choose a directory and loads all .csv files
...
bit_csv_all <- function() {
  ...
  if (nzchar(directory)) {
    ...
    if (length(files) > 0) {
      ...
      print(gettext("No .csv files found in the directory."))
    }
  } else {
